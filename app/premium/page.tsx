...
function Toast({ message, show }: { message: string; show: boolean }) {
  return (
    <motion.div
      ...
      className="fixed bottom-24 right-8 z-50 px-6 py-4 bg-gradient-to-r from-purple-600 to-blue-600 rounded-xl text-white font-bold shadow-2xl"
    >
...
export default function PremiumPage() {
  ...
  return (
    <div className="min-h-screen pt-24 pb-16 relative overflow-hidden akari-theme">
      ...
      <motion.div className="absolute inset-0 overflow-hidden pointer-events-none" style={{ perspective: '1000px' }}>
        {[...Array(20)].map((_, i) => (
          <motion.div
            key={i}
            className="absolute"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-purple-600/20 to-blue-600/20 border-2 border-purple-500/50 rounded-full px-6 py-3 backdrop-blur-sm">
            <StarIcon className="w-6 h-6 text-purple-400 animate-pulse" />
            <span className="text-purple-300 font-bold text-lg">Premium Bot</span>
          </div>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            ...
            <p className="text-gray-400 text-xl md:text-2xl leading-relaxed mb-8">
            ...
            <div className="flex flex-wrap gap-4 mb-12">
              <motion.button
                ...
                className="px-10 py-5 bg-gradient-to-r from-purple-600 to-blue-600 rounded-full text-white font-bold text-xl glow-purple hover:shadow-2xl transition-all duration-300"
              >
              ...
              <Link
                ...
                className="px-10 py-5 bg-white/5 backdrop-blur-sm border-2 border-purple-500/30 rounded-full text-white font-bold text-xl hover:bg-white/10 hover:border-purple-500/50 transition-all duration-300 text-center"
              >
                View Commands
              </Link>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              {akariStats.map((stat, index) => (
                <motion.div
                  ...
                  whileHover={{ scale: 1.05 }}
                  className="p-6 rounded-xl bg-white/5 backdrop-blur-sm border border-purple-500/20 hover:border-purple-500/50 transition-all cursor-pointer group relative"
                >
                  <div className="text-3xl font-bold gradient-text-akari mb-2 group-hover:scale-110 transition-transform">
          ...
          {/* Right Side - Animated Bot Showcase */}
          <motion.div
            initial={{ opacity: 0, x: 50 }}
            animate={{ opacity: 1, x: 0 }}
          ...
          >
            <div className="relative w-full aspect-square max-w-lg mx-auto">
              ...
              <motion.div
                ...
                className="absolute inset-12 rounded-full border-2 border-blue-500/30 border-dashed"
              >
              ...
              <motion.div
                ...
                className="absolute inset-20 rounded-full bg-gradient-to-br from-purple-600 via-blue-600 to-purple-800 glow-purple flex items-center justify-center overflow-hidden"
              >
                <motion.div
              ...
              <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex gap-2">
                {[...Array(5)].map((_, i) => (
                  <motion.div
                    key={i}
                    animate={{
                      height: ['20px', `${40 + Math.random() * 40}px`, '20px'],
                    }}
                    transition={{
                      duration: 0.8,
                      repeat: Infinity,
                    ...
                    className="w-2 bg-gradient-to-t from-purple-600 to-blue-400 rounded-full"
                  />
                ))}
              </div>
              ...
              <motion.div
                ...
                className="absolute inset-16 rounded-full bg-purple-600/20 blur-3xl"
              />
            </div>
          </motion.div>
        </div>
        ...
        <div className="mb-20">
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-4xl font-bold gradient-text-akari text-center mb-12"
          >
            Premium Features
          </motion.h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {akariFeatures.map((feature, index) => (
              ...
              >
                <div className="p-8 rounded-2xl bg-white/5 backdrop-blur-sm border border-purple-500/20 hover:border-purple-500/50 transition-all duration-300 h-full relative overflow-hidden">
                  <motion.div
                  ...
                  <motion.div 
                    className="w-14 h-14 rounded-xl bg-gradient-to-br from-purple-600 to-blue-600 flex items-center justify-center mb-6 glow-purple relative z-10"
                    whileHover={{ 
                      rotate: [0, -10, 10, -10, 0],
                      scale: 1.1,
                    }}
        ...
        <div className="mb-20">
          <motion.h2
            ...
            whileInView={{ opacity: 1 }}
            viewport={{ once: true }}
            className="text-4xl font-bold gradient-text-akari text-center mb-8"
          >
            75+ Premium Commands
          </motion.h2>
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="text-center p-12 rounded-2xl bg-white/5 backdrop-blur-sm border border-purple-500/20"
          >
            <div className="grid md:grid-cols-3 gap-8 mb-8">
              <motion.div 
                whileHover={{ scale: 1.05 }}
                className="p-6 rounded-xl bg-purple-600/10 border border-purple-500/30"
              >
                <div className="text-4xl font-bold gradient-text-akari mb-2">7</div>
              ...
              <motion.div 
                ...
                className="p-6 rounded-xl bg-purple-600/10 border border-purple-500/30"
              >
                <div className="text-4xl font-bold gradient-text-akari mb-2">75+</div>
              ...
              <motion.div 
                ...
                className="p-6 rounded-xl bg-purple-600/10 border border-purple-500/30"
              >
                <div className="text-4xl font-bold gradient-text-akari mb-2">20+</div>
                <div className="text-gray-400">Audio Filters</div>
              </motion.div>
            </div>
        ...
        <div id="comparison" className="mb-20">
          ...
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="overflow-x-auto rounded-2xl bg-white/5 backdrop-blur-sm border border-purple-500/20"
          >
            <table className="w-full">
              <thead>
                <tr className="border-b border-purple-500/20">
                  <th className="px-6 py-5 text-left text-white font-bold text-lg">Feature</th>
                  <th className="px-6 py-5 text-center text-pink-400 font-bold text-lg">
                    <div className="flex items-center justify-center gap-2">
                      <span className="w-3 h-3 bg-pink-500 rounded-full animate-pulse" />
                      Hikari (Free)
                    </div>
                  </th>
                  <th className="px-6 py-5 text-center text-purple-400 font-bold text-lg">
                    <div className="flex items-center justify-center gap-2">
              ...
              <tbody>
                {comparison.map((row, index) => (
                  ...
                  >
                    <td className="px-6 py-4 text-white font-medium group-hover:text-purple-300 transition-colors">
                      {row.feature}
                    </td>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-8">
            <motion.div
              ...
              className="p-6 rounded-xl bg-gradient-to-br from-pink-600/10 to-pink-600/5 border border-pink-500/30 text-center"
            >
              <div className="text-3xl mb-2">🎵</div>
              <h4 className="text-pink-400 font-bold mb-2">Hikari Free</h4>
              <p className="text-gray-400 text-sm">Perfect for casual music lovers</p>
            </motion.div>

            <motion.div
              whileHover={{ scale: 1.05, y: -5 }}
              className="p-6 rounded-xl bg-gradient-to-br from-purple-600/20 to-blue-600/20 border-2 border-purple-500/50 text-center relative overflow-hidden"
            >
              <motion.div
              ...
              <h4 className="gradient-text-akari font-bold mb-2 relative z-10">Akari Premium</h4>
              <p className="text-gray-300 text-sm relative z-10">Ultimate experience for power users</p>
            </motion.div>

            <motion.div
              whileHover={{ scale: 1.05, y: -5 }}
              className="p-6 rounded-xl bg-gradient-to-br from-green-600/10 to-green-600/5 border border-green-500/30 text-center"
            >
              <div className="text-3xl mb-2">🚀</div>
              <h4 className="text-green-400 font-bold mb-2">3x More Features</h4>
              <p className="text-gray-400 text-sm">Get premium for maximum power</p>
            </motion.div>
          </div>
        </div>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1 }}
          viewport={{ once: true }}
          className="text-center p-12 rounded-3xl bg-gradient-to-br from-purple-600/20 to-blue-600/20 border-2 border-purple-500/30 backdrop-blur-sm"
        >
          <SparklesIcon className="w-16 h-16 text-purple-400 mx-auto mb-6 animate-pulse" />
          <h2 className="text-4xl font-bold gradient-text-akari mb-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link
              href="/support"
              className="inline-block px-10 py-5 bg-white/5 border-2 border-purple-500/30 rounded-full text-white font-bold text-xl hover:bg-white/10 transition-all duration-300"
            >
              Contact Support
            </Link>
          </div>
      ...
      >
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          className="flex items-center gap-3 px-6 py-4 bg-gradient-to-r from-purple-600 to-blue-600 rounded-full text-white font-bold shadow-2xl glow-purple relative"
        >
          <SparklesIcon className="w-6 h-6" />
          <span className="hidden md:inline">Add Akari Now</span>
